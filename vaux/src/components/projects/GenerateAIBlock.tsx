                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex gap-4 items-center">
                                ...
                                <div
                                    ...
                                    <Select className="generate-block-select" sx={selectStyles} defaultValue="Neutral"
                                            ...
                                            onChange={(event) => updateGenerateBlockDetail('emotion', event.target.value)}>
                                        {
                                            ...
                                            selectedAIVoice.Emotion.map(emotion => {
                                                return <MenuItem key={emotion}
                                                                 value={emotion.toLowerCase()}>{emotion}</MenuItem>
                                            })
                                        }
                                    </Select>
                                </div>
                                <div className="relative">
                                    ...
                                    {openPitch && (
                                        <>
                                            <div
                                                className="absolute top-[110%] left-[40%] w-[0px] h-[0px] border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-b-[12px]"></div>
                                            <SliderDropdown positionStyles={`top-[145%] left-[-174%]`}
                                                            sliderValue={generateBlockDetail.pitch} stepValue={1}
                                                            sliderChanged={(value) => updateGenerateBlockDetail("pitch", value)}
                                                            defaultValue={0} min={-50} max={50}
                                                            sliderOptions={pitchSliderOptions}/>
                                        </>
                                    )}
                                </div>
                                <div className="relative">
                                        ...
                                        <>
                                            ...
                                            <ClickAwayListener onClickAway={() => setOpenSpeed(false)}>
                                                <SliderDropdown
                                                    ...
                                                    sliderValue={generateBlockDetail.duration} stepValue={0.5}
                                                    sliderChanged={(value) => updateGenerateBlockDetail("duration", value)}
                                                    defaultValue={1} min={1} max={3}
                                                    sliderOptions={speedSliderOptions}/>
                                            </ClickAwayListener>
                                        </>
                                    )}
                                </div>
